...
public sealed class CreateApplicationCommandHandler(IApplicationsRepository repository, IValidator<CreateApplicationCommand> validator) : IRequestHandler<CreateApplicationCommand, ApplicationDto>
{
